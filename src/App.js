...
const App = () => {
    ...
    const generateStarMessages = () => {
        return  [
            ...
            "In a crowded universe, you stand out in silence, Roja, and it captures my heart. 🌟",
            ...
            "You light up the night, even if you don’t notice how much you mean to me, Roja. ✨",
            ...
            "Like a secret constellation, you shine in my thoughts, even from a distance, Roja. 🔭",
            ...
            "Roja, I often wonder about the stories you hold, even if I don’t know them. 💭",
            "In a galaxy of dreams, I find your light to be uniquely captivating, Roja. 🌈",
            ...
            "You are a melody that plays softly in my mind, echoing long after we've met, Roja. 🎶",
            ...
            "Mysteries of the universe lie in quiet moments, like the ones I cherish thinking of you, Roja. 🌟",
            ...
            "Even the smallest stars can light up the darkest nights, just as you brighten my life, Roja. 🌌",
            "Your laughter echoes in my mind, a reminder of the distance between us, Roja. 🌠",
            "Behind every star lies a story waiting to be discovered, and I wish to know yours. 📜",
            "Roja, like stars, some people shine brighter in silence, and you are one of them. 🔮",
            "Your dreams are constellations in my heart, even if you don't know it, Roja. 🌌",
            "In the theater of the universe, I see you playing a role that captivates me. 🎭",
            "The cosmos hums a tune that only I seem to hear, and it's your song, Roja. 🎶",
            "Every moment shared is like a star added to my sky, even if you don't see it, Roja. ✨",
            "Your essence is a silent song of the night that resonates deeply within me, Roja. 🌙",
            ...
            "The universe seems to conspire to keep you in my thoughts, Roja, even from afar. 🌌",
            ...
            "Roja, in the garden of dreams, you are a rare bloom that captivates my heart. 🌸",
            ...
            "Every star is a wish I silently hope will come true for you, Roja. 🌟",
            ...
            "Roja, your laughter fills my heart, but it’s a melody only I hear. 🎇",
            "You are the muse of my silent thoughts, inspiring me from afar, Roja. 📜",
            "Every thought of you shines brighter than anything else in my mind. 🌠",
            "You are the sparkle in my universe, even if you don’t know it, Roja. ✨",
            ...
            "Roja, your heart seems to be the compass guiding me through uncharted waters. 🏡",
            "In the grand tapestry of the cosmos, you are a thread I can’t quite grasp. 🌌",
            "Your spirit sparkles like diamonds, but I admire you quietly, Roja. 💎",
            ...
            "Roja, you are a symphony of stars that plays softly in my heart, heard only by me. 🎶",
            "Your essence fills my thoughts with warmth, even if you’re far away. ❤️",
            "Every star in the sky tells a story, and yours captivates my imagination, Roja. 🌌",
            "You are the evening star that brings me peace, even from a distance. 🌙",
            "Roja, your love is a radiant light that illuminates my path, but it’s a path I walk alone. ❤️",
            ...
            "In this vast universe, you are my favorite star, even if you don’t know it, Roja. 🌟",
